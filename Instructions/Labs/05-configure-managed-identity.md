...
1. **[+ 作成]** を選択し、必須の詳細を入力します。
    ...
    | **プロジェクトの詳細** | **リージョン** | Web アプリをホストするリージョンを選択します。 |
    | **Web アプリの詳細** | **名前** | Web アプリの一意の名前を入力します。 |
    | **Web アプリの詳細** | **ランタイム スタック** | .NET 8 (LTS) |
    | **データベース** | **エンジン** | SQLAzure |
    | **データベース** | **サーバー名** | 使用する SQL サーバーの一意の名前を入力します。 |
    | **データベース** | **データベース名** | 使用するデータベースの一意の名前を入力します。 |
    | **ホスティング** | **ホスティング プラン** | 基本 |
...
1. Azure Data Studio のデータベースに接続し、次のコードを実行します。
...
1. Azure Data Studio を使用して Azure SQL データベースに接続します。 **[Microsoft Entra ID - Universal with MFA support]** を選択し、ユーザー名を指定します。
